...
- **문제 상황1:** 민감 개인 정보 자동 메일 발송 서비스
	- 수십개의 조합 별로 수신자, 수십명에게 각각 문서 PDF를 첨부하여 메일을 발송해야 했음. 현재 문서는 하나의 통합된 파일로 존재하는 상황임. 메일 발송시 제목, 본문, 파일, 참조, 숨은 참조 등을 통제해야 하는 상황. 
...
- **문제상황2 :** 웹 데이터 수집 서비스
	- 60개의 웹사이트에서 데이터를 수집할 수 있는 자동화 시스템을 구축해야 하는 상황. 엑셀 위의 공고를 쌓아주기로 했음. 어떻게 내개 해당 사이트의 데이터 수집이 적절하게 이루어지고 있다고 진실성을 담보할 수 있을까? 어떻게 테스트를 설계해야 할까? 어떻게 개발자가 아닌, 비개발자 이용자들이 이 사이트를 믿게 할 수 있을까?
